...
namespace Meeteam_Backend.Controllers
{
    ...
    public class FileController : ControllerBase
    {
        ...
        public string OpenFile(string target, string id)
        {
            ...
            if (target == "temporary")
            {
                filename = @"C:\workspace\storage\temporary\" + id;
            }
        ...
        public int CopyFile(string project_id,string filename)
        {
            ...
            entity.img_path = @"C:\workspace\storage\project_img\"+filename;
            if (!System.IO.File.Exists(entity.img_path))
            {
                using (FileStream fs = System.IO.File.Create(entity.img_path))
                {
                    string src = @"C:\workspace\storage\temporary\" + filename;
