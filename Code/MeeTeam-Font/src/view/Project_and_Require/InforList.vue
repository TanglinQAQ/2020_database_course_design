  ...
  <el-main>
    ...
    <div style="height: 50px;">
      <div class="filter-container">
        ...
        &nbsp;
        <el-button class="filter-item" type="primary" icon="el-icon-search" @click="searchContList" style="float:right">
          搜索
        </el-button>
      </div>
    </div>
            ...
            <div style="margin-top:15px">
              ...
              <el-card :body-style="{ padding: '0px' }" shadow="hover">
                ...
                <div class="text">
                  ...
                  <template>
                    <el-button type="success" plain size="mini" style="float:right" @click="handleLook(index, o.row)">
                      了解更多</el-button>
                  </template>
                  <br>
                </div>
